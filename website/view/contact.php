...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Google Maps -->
    <script src="../resources/bootstrap/https://maps.googleapis.com/maps/api/js?key=AIzaSyAwuyLRa1uKNtbgx6xAJVmWy-zADgegA2s"></script>
    <script src="../resources/bootstrap/js/google-map/map-active.js"></script>
</body>
