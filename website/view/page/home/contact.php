...
<div class="contact-information-area section-padding-80">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3">
                <div class="contact-text">
                    <p>Nous nous réjouissons de recevoir votre appréciation sur les recettes que vous avez pu cuisiner</p>
                    <p>N'hésitez pas à nous donner votre avis directement sur le formulaire de contact ci-dessous</p>
                </div>
            </div>
        </div>
    </div>
