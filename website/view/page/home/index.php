                ...
                <div class="col-12 col-lg-6">
                    <div class="single-contact-information mb-30" styles="width: 100%;">
                        ...
                        <p>La foire aux recettes est un site crée par des élèves apprentis de l'ETML afin de démontrer nos capacités en HTML, CSS, PHP et MySQL.
                            Ce projet a été réalisé par Serghei Diulgherov, Thimothée Carlier, Yannick Pena et Yann Imperadori avec Antoine Mveng en tant que chef de projet.
                             Ce projet vise à mettre en oeuvre les connaissances apprises dans les modules 133 et 151 qui ce sont déroulés en parallèle du projet.
                             Ce site vous permet de visualiser une variété de recettes séparées en différetes catégories ainsi que leur attribuer une note et ajouter un commentaire.
                             Vous avez aussi la possibilité de nous contacter directement sur la page concernée et nous feront de notre mieux pour vous répondre.
                             Soyez les bienvenus à tester jouer avec toutes les fonctionnalités du site et sourtout n'hésitez pas à tester les recettes!
                        </p>
                    </div>
                </div>
