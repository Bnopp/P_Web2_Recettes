...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="../resources/bootstrap/img/core-img/favicon.ico">
                                        ...
                                        <div class="megamenu">
                                            ...
                                            <div class="single-mega cn-col-4">
                                                <div class="receipe-slider owl-carousel">
                                                    <a href="#"><img src="../resources/bootstrap/img/bg-img/bg1.jpg" alt=""></a>
                                                    <a href="#"><img src="../resources/bootstrap/img/bg-img/bg6.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="col-12">
                    <div class="delicious-cool-facts-area">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="../resources/bootstrap/img/core-img/hamburger.png" alt="">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="../resources/bootstrap/img/core-img/rib.png" alt="">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="../resources/bootstrap/img/core-img/pancake.png" alt="">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="../resources/bootstrap/img/core-img/hamburger2.png" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="../resources/bootstrap/img/core-img/pizza.png" alt="">
                                    <h5>Italian Food</h5>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="../resources/bootstrap/img/core-img/cake2.png" alt="">
                                    <h5>Sweets &amp; Cakes</h5>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nec varius dui. Suspendisse potenti. Vestibulum ac pellentesque tortor.</p>
                            </div>
    ...
    <div class="follow-us-instagram">
        ...
        <div class="insta-feeds d-flex flex-wrap">
            ...
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta1.jpg" alt="">
                <!-- Icon -->
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta2.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta3.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta4.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta5.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta6.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
            ...
            <!-- Single Insta Feeds -->
            <div class="single-insta-feeds">
                <img src="../resources/bootstrap/img/bg-img/insta7.jpg" alt="">
                <!-- Icon -->
                <div class="insta-icon">
                    <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="../resources/bootstrap/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="../resources/bootstrap/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="../resources/bootstrap/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="../resources/bootstrap/js/plugins/plugins.js"></script>
    <!-- Active js -->
    <script src="../resources/bootstrap/js/active.js"></script>
</body>
